const styles = {
    ...
    buttonshopnow: 'w-[150px] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer border-2 border-red-900',
    buttonseller: 'w-[150px] border-2 border-[#ff3d3d] bg-white h-[50px]  hover:bg-red-100  my-3 flex items-center justify-center rounded-xl cursor-pointer',
  };
